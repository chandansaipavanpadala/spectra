...
#
# recreate_project.tcl: Tcl script for re-creating project 'spectra'
#
...
if {![file exists $src_dir]} {
    set src_dir "${origin_dir}/spectra.srcs/sources_1/new"
}
if {![file exists $src_dir]} {
    set src_dir "${origin_dir}/../spectra.srcs/sources_1/new"
}
...
if {![file exists $constr_dir]} {
    set constr_dir "${origin_dir}/spectra.srcs/constrs_1/new"
}
if {![file exists $constr_dir]} {
    set constr_dir "${origin_dir}/../spectra.srcs/constrs_1/new"
}
