...
| **Golden Mean Ratio ($R_{FD}$)** | **$2.78 \times 10^{-4}$** | $< 1.0$ | **PASSED** |
| **Trojan Mean Ratio ($R_{FD}$)** | **$3762.58$** | $\ge 1.0$ | **PASSED** |
...
High-resolution visual plots (300 DPI) generated by the SPECTRA verification pipeline are stored in `screenshots/`:
